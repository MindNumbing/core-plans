...
You can use this passage by adding core/postgresql94 to your package dependencies in your plan file:

```
pkg_deps=(
  core/postgresql94 # for psql in hooks/init
)
```
...
The docker post-process should create a docker image named `core/postgresql94` and it should be available on your local machine
